...
if (!isset($_SESSION['user_id'])) {
  ...
  require_once('core/functions/delDevicefun.php');
}
?>
...
<body>
            ...
            <div class=" col-lg-12">
              <div class="card">
                <div class="card-title">
                  <h4 class='manageDevices'>Manage Devices</h4>
  ...
  <script src="assets/language/manageDevices.js"></script>
